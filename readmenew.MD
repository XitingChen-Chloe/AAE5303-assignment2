...
├── Examples/Monocular/
│   ├── HKisland_Mono.yaml
│   ├── HKisland_Mono_downsampled.yaml      # 4× config
│   └── HKisland_Mono_downsampled2.yaml     # 2× config (current)
├── Examples_old/ROS/ORB_SLAM3/
│   └── src/ros_mono_compressed.cc          # Modified: compressed + downsampling
├── src/
│   └── System.cc                           # Modified: SaveTrajectoryTUM for monocular
